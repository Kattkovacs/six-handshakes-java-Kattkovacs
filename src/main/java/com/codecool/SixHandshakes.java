...
public class SixHandshakes {
    ...
    private static void friendsOfFriends() {
        ...
        Set<UserNode> friendsOfFriends = FriendsOfFriendsFinder.getFriendsOfFriends(searchForFriends, distance);
        visualizeFriendCircle(friendsOfFriends, searchForFriends);
    }
    ...
    private static UserNode getUserByGivenName() {
        ...
        while (true) {
            ...
            System.out.println("The person does not exist. Give another name.");
        }
    }
